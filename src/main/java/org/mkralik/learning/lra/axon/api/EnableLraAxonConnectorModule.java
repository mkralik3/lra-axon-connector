...
@Documented
@Import({AxonLraConfiguration.class, CommandDispatchInterceptor.class, EventDispatchInterceptor.class, CommandHandlerInterceptor.class, EventHandlerInterceptor.class, AxonLraEndpointsSpring.class})
@Configuration
